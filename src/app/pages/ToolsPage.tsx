...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    titleKo: "재무 관리",
    titleEn: "Finance",
    descKo: "매출, 지출, 예산을 한곳에서 관리하세요.",
    descEn: "Manage revenue, expenses, and budgets in one place.",
    detailKo: "매출 현황, 지출 내역, 카테고리별 예산 관리, 손익 분석을 한 화면에서 확인합니다. 고객관리 데이터와 자동 연동됩니다.",
    detailEn: "Track revenue, expenses, budgets by category, and P&L analysis in one view. Auto-syncs with client management data.",
    status: "active",
    category: "page",
  },
  {
